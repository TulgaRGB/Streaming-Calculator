...
export const paragraphs: Paragraph[] = [
  {
    ...
    body:
      "Streaming royalties are the main source of income for artists. In fact, they are fees paid to artists and songwriters for every stream on platforms like Spotify, YouTube and Apple Music.",
  },
  {
  ...
  },
  {
    ...
    body:
      "Spotify pays between $0.003 and $0.0084 per stream. This figure may depend on the listener's location, song popularity and other factors. Music Royalty Calculator uses $0.00348 as the rate per stream on Spotify, therefore, the actual earning may be higher.",
  },
];
